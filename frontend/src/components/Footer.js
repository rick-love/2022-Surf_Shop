...
<footer className="bg-white dark:bg-gray-800 w-full py-8">
    <div className="max-w-screen-xl mx-auto px-4">
        ...
        <div className="pt-8 flex max-w-xs mx-auto items-center justify-between">
            ...
            {/* Github */}
            <a href="https://github.com/rick-love/" className="text-gray-400 hover:text-gray-800 dark:hover:text-white transition-colors duration-200">
            ...
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/in/rickl1/" className="text-gray-400 hover:text-gray-800 dark:hover:text-white transition-colors duration-200">
                <svg width="20" height="20" fill="currentColor" className="text-xl hover:text-gray-800 dark:hover:text-white transition-colors duration-200" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
